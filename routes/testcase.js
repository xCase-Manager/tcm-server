...
module.exports = function(ctx) {
  ...
  */
  server.get('/api/testcases', (req, res) => {
    testcaseService.getTestcases(undefined, req.query.search).then(function(result) {
  ...
  */
  server.get('/api/projects/:projectId/testcases', (req, res) => {
    testcaseService.getTestcases(
     req.params.projectId, req.query.search)
  ...
  */
  server.get('/api/projects/:projectId/testcases/:testcaseId', 
  (req, res) => {
  ...
  */
  ...
  projectService.findProject(req.params.projectId)
    ...
    .catch( err => {
      console.log("could not create the testcase for project id '%s', " +
      "error: %s", 
  ...
  */
  server.put('/api/projects/:projectId/testcases/:testcaseId', (req, res) => {
    ...
    testcaseService.updateTestcase(req.params.testcaseId, 
  ...
  */
  server.del('/api/projects/:projectId/testcases/:testcaseId', (req, res) => {
    testcaseService.deleteTestcase(
      req.params.testcaseId, req.params.projectId).then(function(result) {
        ((result.n) && result.n > 0)
